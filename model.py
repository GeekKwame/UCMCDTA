...
#cmpnn
        ...
        self.L2ceng452_256 = nn.Linear(452,int(512/2))
    ...
    def forward(self, data):
        ...
        A69_protein_tensor = protein1[-1].to(self.device) # case torch.Size([452, 30])
        A69_protein_tensor = self.L1ceng30_1(A69_protein_tensor) # case
        A69_protein_tensor = A69_protein_tensor.reshape(A69_protein_tensor.shape[0])
        if A69_protein_tensor.shape[0] == 452:  # case_study
            A69_256_protein_tensor = self.L2ceng452_256(A69_protein_tensor)
        else:
